...
!!! note "PART A: Theory"
    This part is dedicated for theoretical fundamentals of embedded systems.
...
!!! note "PART B: ENGINEERING"
    This part is dedicated for engineering practices of embedded systems.
...
-   :simple-stmicroelectronics:{ .lg .middle } __STM32__
    ...
    [:octicons-arrow-right-24: <a href="https://www.st.com/en/microcontrollers-microprocessors/stm32-32-bit-arm-cortex-mcus.html" target="_blank"> STM32 Official </a>](#)
...
-   :simple-espressif:{ .lg .middle } __ESP32__
    ...
    [:octicons-arrow-right-24: <a href="https://www.espressif.com/en/products/socs/esp32" target="_blank"> ESP32 Official </a>](#)
...
-   :fontawesome-brands-aws:{ .lg .middle } __REAL TIME OPERATING SYSTEM FreeRTOS__
...
-   :simple-hackster:{ .lg .middle } __HACKSTER IO__
    ...
    [:octicons-arrow-right-24: <a href="https://www.hackster.io/" target="_blank"> Hackster IO Official </a>](#)
...
-   :material-raspberry-pi:{ .lg .middle } __Raspberry Pi__
    ...
    [:octicons-arrow-right-24: <a href="https://www.raspberrypi.org/" target="_blank"> Raspberry Pi Official </a>](#)

-   :simple-nvidia:{ .lg .middle } __Jetson Nano__

    ---

    [:octicons-arrow-right-24: <a href="https://developer.nvidia.com/embedded/jetson-nano-developer-kit" target="_blank"> Jetson Nano Official </a>](#)

-   :simple-linux:{ .lg .middle } __Linux__

    ---

    [:octicons-arrow-right-24: <a href="https://ubuntu.com/" target="_blank"> Ubuntu Official </a>](#)
