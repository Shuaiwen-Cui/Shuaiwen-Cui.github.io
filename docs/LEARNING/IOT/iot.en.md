...
-   :simple-influxdb:{ .lg .middle } __InfluxDB__
    ...
    [:octicons-arrow-right-24: <a href="https://www.influxdata.com/time-series-platform/influxdb/" target="_blank"> Portal </a>](#)
...
-   :simple-grafana:{ .lg .middle } __Grafana__
    ...
    [:octicons-arrow-right-24: <a href="https://grafana.com/" target="_blank"> Portal </a>](#)
