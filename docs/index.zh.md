...
<a href="/Resume_Shuaiwen_CUI_2026-CHINESE.pdf" target="_blank">📜  查看与下载我的简历-中文 (2026)</a>

<a href="/Resume_Shuaiwen_CUI_2026-ENGLISH.pdf" target="_blank">📜 查看与下载我的简历-英文 (2026)</a>
...
- 平台兼容层开发（配置管理、时间管理、无线传感网络通信等）

- 数学运算子库开发（向量/矩阵运算、线性代数、求逆、特征值/特征向量、SVD、各类分解、模态分析等高级计算）

- 信号处理子库开发（卷积、相关分析、重采样、FIR/IIR滤波、FFT、DWT、ICA等算法）

- 机器学习子库开发（支持推理、训练、量化压缩等完整AI生命周期）

- 结构健康监测专用模块开发（涵盖在线/离线多种模式测量、轻量高效系统识别（PP/FDD/EFDD/ITD/Next-ERA/SSI-Cov等）、损伤检测/定位/严重度评估等算法）
...
- **Cui, S.**, Fu, Y.*, Xia, Y., Zhang Q., & Li, S. (2026). A Class-Lab-Field Pedagogical Framework for Structural Health Monitoring using Ultra-Low-Cost Wireless IoT Prototypes. IEEE Transactions on Education. [https://doi.org/10.1109/TE.2026.3717462](https://doi.org/10.1109/TE.2026.3717462){:target="_blank"}
